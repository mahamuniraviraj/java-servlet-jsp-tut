...
@WebServlet(name = "MySecondServlet", urlPatterns = { "/hello", "/s2", "/servlet2" },
		initParams = {
				@WebInitParam(name = "version", value = "3.0"),
				@WebInitParam(name = "myGrettings",
						value = "This is your last chance. After this, there is no turning back. You take the blue pill - the story ends, you wake up in your bed and believe whatever you want to believe. You take the red pill - you stay in Wonderland and I show you how deep the rabbit-hole goes. ")
		})
public class MySecondServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String greetings = this.getServletConfig().getInitParameter("myGrettings");

		resp.getWriter().write(
				"<h2> msg is <q>" + greetings + "</q>  Version  :" + version + " ::</h2><br/>");
