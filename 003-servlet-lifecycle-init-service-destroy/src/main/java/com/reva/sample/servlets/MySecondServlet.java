...
public class MySecondServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		super.init(config);
		System.out.println(" Servlet 2 Initialised");
	}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().write("<h2>Hello World from Servlet : 2 ::</h2><br/><h2>" + LocalDateTime.now() + "</h2>");
	}
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println(" Servlet 2 service method was called");
	}
	...
	public void destroy() {
		...
		super.destroy();
		System.out.println(" Servlet 2 destroyed");
	}
